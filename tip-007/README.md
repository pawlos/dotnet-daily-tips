...
Using MemberNotNullWhen attribute to indicate when Value is not null and when Error is not based on the IsSuccessful property. With that additional help - no red squiggly.
