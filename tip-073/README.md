...
`Half` is a fourth type that was introduced in .NET 5. To be honest I must have missed it myself. It is 2 bytes in size and allows storing values up to around 65k. It also allows representing positive and negative zeros, +∞, -∞, and of course, NaN.
